    ...
    <div class="wrap">
        ...
        <div class="wrap__main">
            ...
            <div class="wrap__content">
                <h2 class="user__list">编辑管理员</h2>
                <br/>
                <form action="{{ url('admin/manage/'.$admin->id) }}" method="post" class="form-horizontal" id="register_form">
                    {{ csrf_field() }}
                    {{ method_field('put') }}
                    ...
                    <div class="form-group">
                        <div class="form-group-row">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" name="username"  id='username' value="{{ $admin->username }}" placeholder="请填写用户名">
                            </div>
                        </div>
                        <br><br>
