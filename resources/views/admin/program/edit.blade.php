    ...
    <div class="wrap">
        ...
        <div class="wrap__main">
            ...
            <div class="wrap__content">
                <h2 class="user__list">编辑专业</h2>
                <br/>
                <form action="{{ url('admin/program/' . $program->id) }}" method="post" class="form-horizontal" id="program_form">
                    {{ csrf_field() }}
                    {{ method_field('put') }}
                        ...
                        <div class="form-group-row">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" name="name"
                                       id='name' value="{{ $program->name }}" placeholder="请填写专业名">
                            </div>
                        </div>
                        <br><br><br>
