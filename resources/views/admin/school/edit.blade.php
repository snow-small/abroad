    ...
    <div class="wrap">
        ...
        <div class="wrap__main">
            ...
            <div class="wrap__content">
                ...
                <br/>
                <form action="{{ url('admin/school/'.$school->id) }}" method="post" class="form-horizontal" id="school_form">
                    {{ csrf_field() }}
                    {{ method_field('put') }}
                        ...
                        <div class="form-group-row">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" name="name"
                                       id='name' value="{{ $school->name }}" placeholder="请填写院校名">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-3">
                                <select name="p_id" id="p_id" class="form-control">
                                    @foreach ($provinces as $province)
                                        ...
                                        @if ($school->p_id == $province->id) selected @endif>{{ $province->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group-row">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" name="icon"
                                       id='icon' value="{{ $school->icon }}">
                                <img src="{{ asset('') }}{{ $school->icon }}"
                                     style="width:60px;height:60px;padding:10px 0;" id="icon_image" alt="">
                        ...
                        <div class="form-group-row">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" name="bgImg"
                                       id='bgImg' value="{{ $school->bgImg }}">
                                <img src="{{ asset('') }}{{ $school->bgImg }}"
                                     style="width:100px;height:60px;padding:10px 0;" id="bg_image" alt="">
                        ...
                        <div class="form-group-row">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" name="students"
                                       id='students' value="{{ $school->students }}" placeholder="请填写人数">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group-row">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" name="websit"
                                       id='websit' value="{{ $school->websit }}" placeholder="请填写网址">
                            </div>
                        </div>
                        <br><br><br>
