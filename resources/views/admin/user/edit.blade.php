    ...
    <div class="wrap">
        ...
        <div class="wrap__main">
            ...
            <div class="wrap__content">
                <h2 class="user__list">编辑用户</h2>
                <br/>
                <form action="{{ url('admin/user/'.$user->id) }}" method="post" class="form-horizontal" id="register_form">
                    {{ csrf_field() }}
                    {{ method_field('put') }}
                    ...
                    <div class="form-group">
                        <div class="form-group-row">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" name="username"  id='username' value="{{ $user->username }}" placeholder="请填写用户名">
                            </div>
                        </div>
                        <br><br>
                        ...
                        <div class="form-group-row">
                            ...
                            <div class="col-md-3">
                                <label for="male" class="radio-inline">
                                    <input type="radio" name="sex" id="male" value="male" checked="{{ $user->sex == 'female'?'checked':'' }}"> 男
                                </label>
                                <label for="female" class="radio-inline">
                                    <input type="radio" name="sex" id="female" value="female" checked="{{ $user->sex == 'female'?'checked':'' }}"> 女
                                </label>
                            </div>
                        </div>
                        <br><br>
                        ...
                        <div class="form-group-row">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" value="{{ $user->phone }}" name="phone"  id='phone' placeholder="请填写手机号">
                            </div>
                        </div>
                        <br><br><br>
